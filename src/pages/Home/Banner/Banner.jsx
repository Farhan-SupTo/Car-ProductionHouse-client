...
const Banner = () => {
    return (
        <div className="carousel w-full h-[600px] rounded-xl mb-10">
        <div id="slide1" className="carousel-item relative w-full">
          <img src= {img1} className="w-full" />
          <div className="absolute flex transform items-center h-full left-0 top-o bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)]">
           <div className=' text-white space-y-7 w-1/2 pl-4'>
            <h2 className=' text-6xl font-bold'>Affordable Price For Car Servicing</h2>
            <p>There are many variations of passages of  available, but the majority have suffered alteration in some form.</p>
            <div >
            <button className="btn btn-error text-white mr-4">Warning</button>
            <button className="btn btn-outline text-white">Default</button>
            </div>
           </div>
          </div>
